...
func schema_pkg_apis_application_v1alpha1_ApplicationSetApplicationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ApplicationSetApplicationCondition contains details about each Application managed by the ApplicationSet",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"application": {
						SchemaProps: spec.SchemaProps{
					...
					"observedHash": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedHash contains the last applied hash of the generated Application resource",
							Type:        []string{"string"},
							Format:      "",
						},
					},
